...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="userphoto.php" class="active" ><i class="fas fa-camera-retro"></i><span>Photo Gallery</span></a>
    ...
    <p style="text-align: center; font-size: 50px">Glimpse of society...!!</p>
